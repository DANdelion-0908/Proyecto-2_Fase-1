        	...
        	try {
                ...
                System.out.println("3. Salir. \n");
                    ...
                    if(mainOpt == 1) {
                        ...
                        System.out.printf("La hamburguesa con la tercera mayor cantidad de coincidencias es: %s con %d puntos.\n\n", makeRecommendation.getThird(makeRecommendation.getMax().entrySet().iterator().next().getKey(), makeRecommendation.getSecond(makeRecommendation.getMax().entrySet().iterator().next().getKey()).entrySet().iterator().next().getKey()).entrySet().iterator().next().getKey(), makeRecommendation.getThird(makeRecommendation.getMax().entrySet().iterator().next().getKey(), makeRecommendation.getSecond(makeRecommendation.getMax().entrySet().iterator().next().getKey()).entrySet().iterator().next().getKey()).entrySet().iterator().next().getValue());
